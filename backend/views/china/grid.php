...
//    jQuery("#search-div").filterGrid(grid_selector, {
//        filterModel: {
//            label:'LableFild',
//            name: 'username'
//        }
...
//        }
    ...
    console.info(params, jQuery(grid_selector).jqGrid('getGridParam', 'postData'));
...
//jQuery(grid_selector).jqGrid('filterGrid', "#search-div", {
//  filterModel:  [
//          {
//              label:'LableFild',
//              name: 'colname',
...
// jQuery(grid_selector).jqGrid('filterToolbar',{defaultSearch:true,stringResult:false});
