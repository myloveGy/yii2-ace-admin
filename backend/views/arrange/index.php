...
<script type="text/javascript">
    ...
    var scripts = [null,
        ...
        "/public/assets/js/jquery.dataTables.bootstrap.js",
        "/public/assets/js/common/base.js",
        "/public/assets/js/common/dataTable.js",
        "/public/assets/js/layer/layer.js",
    ...
    ace.load_ajax_scripts(scripts, function() {
        ...
        jQuery(function ($) {
            var myTable = new MeTable({sTitle: "管理员日程安排"}, {
                "sAjaxSource": "<?=\yii\helpers\Url::toRoute(['arrange/search'])?>",
                "aoColumns": [
                    oCheckBox,
                    {
                        "title": "id ",
