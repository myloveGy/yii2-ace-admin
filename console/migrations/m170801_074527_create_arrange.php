...
class m170801_074527_create_arrange extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable($this->table, [
            ...
            'status' => $this->smallInteger(2)->notNull()->defaultValue(0)->comment('状态[0 - 待处理 1 - 已委派 2 - 完成 3 延期]'),
            'time_status' => $this->smallInteger(2)->notNull()->defaultValue(0)->comment('事件状态[0 - 延缓 1 - 正常 2 - 紧急]'),
